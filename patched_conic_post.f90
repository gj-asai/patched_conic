! Realiza as mesmas contas, mas agora retorna valores de interesse para pos-processamento
    
subroutine patched_conic_post(v0, lambda1, deltav, deltav1, deltav2, deltat, gamma0)
    use physical_param
    implicit none
